...
parser = argparse.ArgumentParser(
    description='Run ablation against various transformers',
...
parser.add_argument(
    ...
    default=[
        ...
        'bert_reduce_factor_64',
        'roberta_reduce_factor_64',
    ],
...
def generate_perf_tables(perf_df: pd.DataFrame) -> Dict[str, str]:
    ...
    return {'transformer_ablation': tabulate(table_data, headers, tablefmt='latex')}
